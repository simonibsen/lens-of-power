...
NOTE: Magnifica Humanitas ([Leo XIV encyclical, 2026](https://github.com/simonibsen/lens-of-power/blob/main/analyses/2026-05-28-holysee-encyclical-magnifica-humanitas-ai.md)) provides a Position 1 restatement: a papal encyclical names "the new monopolies of AI" and an "epistemic, economic and political asymmetry" in which a few control "data, computational resources and regulatory influence" while others are "merely subjected to" the models (¶95, 108–109, 171). Notable because the pattern — derived from Position 5 (Zuboff) — is here independently arrived at by one of the oldest hegemonic institutions in the West.
