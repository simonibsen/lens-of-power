...
## [Inversion of Stated Purpose](inversion-of-stated-purpose.md)
...
CONFIDENCE: ESTABLISHED (77 of 94 relevant sources, 82%)
...
CONFIDENCE: ESTABLISHED (22 of 95 relevant sources, 23%)
...
otherwise resist.
CONFIDENCE: ESTABLISHED (20 of 94 relevant sources, 21%)
...
CONFIDENCE: ESTABLISHED (32 of 94 relevant sources, 34%)
...
CONFIDENCE: PRELIMINARY (3 of 95 relevant sources, 3%)

## [The Middle Stratum Trap](middle-stratum-trap.md)
LAYERS: Thought & Narrative, Economic, Institutional
STATEMENT: The middle tier of a power hierarchy is the most heavily
...
solidarity.
CONFIDENCE: PRELIMINARY (7 of 95 relevant sources, 7%)
...
CONFIDENCE: PRELIMINARY (5 of 87 relevant sources, 6%)

## [Appearance as Structural Terrain](appearance-as-structural-terrain.md)
LAYERS: Thought & Narrative, Institutional
STATEMENT: The gap between how a system presents itself and how it
...
CONFIDENCE: ESTABLISHED (74 of 94 relevant sources, 79%)
CIRCUMVENTIONS: Transparency / Naming

## [The Hidden Transcript](hidden-transcript.md)
LAYERS: Thought & Narrative, Surveillance & Information
STATEMENT: Every relationship of domination generates a hidden counter-
narrative among the subordinate — expressed offstage through gossip,
...
CONFIDENCE: SUPPORTED (10 of 86 relevant sources, 12%)
...
CONFIDENCE: SUPPORTED (17 of 95 relevant sources, 18%)
...
the dominant class.
CONFIDENCE: PRELIMINARY (9 of 95 relevant sources, 10%)

## [The Double Performance](double-performance.md)
LAYERS: Thought & Narrative, Institutional, Surveillance & Information
STATEMENT: In most stable power relationships, both the dominant and the
subordinate perform for each other — the ruler performing legitimacy,
...
CONFIDENCE: SUPPORTED (12 of 95 relevant sources, 13%)
...
STATEMENT: Some systems of control are not merely maintained by violence
but constituted through it — the initial distribution of power,
...
CONFIDENCE: ESTABLISHED (22 of 94 relevant sources, 23%)
...
follows a predictable sequence: assimilation (adopting the dominator's
...
CONFIDENCE: PRELIMINARY (2 of 94 relevant sources, 2%)
...
CONFIDENCE: SUPPORTED (16 of 86 relevant sources, 19%)
...
CONFIDENCE: SUPPORTED (17 of 94 relevant sources, 18%)

## [The Unprecedented as Sanctuary](unprecedented-as-sanctuary.md)
LAYERS: Thought & Narrative, Legal & Regulatory, Institutional
STATEMENT: New forms of power establish themselves by operating in
conceptual, legal, and regulatory voids where existing frameworks have
...
CONFIDENCE: SUPPORTED (11 of 95 relevant sources, 12%)

## [The Dispossession Cycle](dispossession-cycle.md)
LAYERS: Thought & Narrative, Institutional, Surveillance & Information
STATEMENT: Surveillance capitalism advances through a repeating four-
...
CONFIDENCE: PRELIMINARY (8 of 95 relevant sources, 8%)

## [The Division of Learning](division-of-learning.md)
LAYERS: Economic, Institutional, Surveillance & Information
STATEMENT: Surveillance capitalism creates a structural asymmetry of
knowledge where one party can learn about, predict, and shape another
who cannot access the data, the predictions, or the modifications
...
generates more data.
CONFIDENCE: ESTABLISHED (28 of 93 relevant sources, 30%)
CIRCUMVENTIONS: Transparency / Naming
...
CONFIDENCE: ESTABLISHED (33 of 94 relevant sources, 35%)

## [Institutional Abdication](institutional-abdication.md)
LAYERS: Legal & Regulatory, Institutional
STATEMENT: Institutions and professionals voluntarily abandon their
structural roles under pressure or anticipation of pressure, creating
the vacuum that authoritarianism fills. Distinct from institutional
capture (where the institution is actively redirected by external
...
CONFIDENCE: ESTABLISHED (24 of 89 relevant sources, 27%)
...
STATEMENT: In the absence of catastrophic disruption, inequality
increases as a structural default. The mechanisms of concentration
...
CONFIDENCE: SUPPORTED (18 of 93 relevant sources, 19%)
...
STATEMENT: Significant, lasting reductions in inequality have
historically been achieved not through redistribution (lifting the
bottom) but through compression (destroying the top). The mechanism is
...
LAYERS: Economic, Legal & Regulatory, Institutional
STATEMENT: Concentrated wealth generates a specialized professional
class — lawyers, accountants, lobbyists, financial advisors, trust
officers, wealth managers — whose structural function is to defend and
grow that wealth. This industry operates with its own institutional
...
STATEMENT: Formal democracy and substantive oligarchy can operate
simultaneously within the same polity without visible contradiction.
...
CONFIDENCE: ESTABLISHED (29 of 95 relevant sources, 30%)
...
LAYERS: Thought & Narrative, Economic, Legal & Regulatory
STATEMENT: Economic power operates not primarily through material
coercion but through a moral vocabulary that converts economic
relationships into moral obligations. The debtor who "must pay," the
worker who "owes loyalty," the citizen who has a "patriotic duty" — each
...
CONFIDENCE: SUPPORTED (11 of 94 relevant sources, 12%)

## [The Capture Pipeline](capture-pipeline.md)
LAYERS: Economic, Legal & Regulatory, Institutional, Surveillance & Information
STATEMENT: Institutional capture operates through a multi-stage,
infrastructure-based pipeline: (1) selection of personnel through a
privately controlled vetting process, (2) installation through funded
campaigns, (3) signaling of desired outcomes through formal channels
repurposed for coordination, (4) manufacturing of inputs (cases,
comments, testimony) designed to produce specific outputs, (5) reward
...
CONFIDENCE: ESTABLISHED (24 of 93 relevant sources, 26%)
...
LAYERS: All layers
STATEMENT: A power structure that operates through multiple layers
simultaneously can survive regime changes that disrupt only some layers
— by adapting the form of control at the disrupted layers while
...
CONFIDENCE: ESTABLISHED (30 of 95 relevant sources, 32%)

## [The Structural Demand for Propaganda](structural-demand-for-propaganda.md)
LAYERS: Thought & Narrative, Institutional, Surveillance & Information
STATEMENT: Propaganda persists not because it is imposed but because it
is structurally needed — by those who exercise power (to govern at scale
...
LAYERS: Thought & Narrative, Surveillance & Information
STATEMENT: Systems of oppression organized along single axes produce
...
CONFIDENCE: PRELIMINARY (2 of 86 relevant sources, 2%)

## [The Boomerang](boomerang.md)
LAYERS: Legal & Regulatory, Institutional, Physical & Coercive
STATEMENT: Methods of domination developed at the periphery of a
...
CONFIDENCE: PRELIMINARY (8 of 93 relevant sources, 9%)
